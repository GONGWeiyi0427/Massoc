...
//Lack of library for ram, tty, vgmn
#include "vci_ram.h"
...
int _main(int argc, char *argv[])
{
  ...
  maptab.add(Segment("tty"  , TTY_BASE  , TTY_SIZE  , IntTab(1), false));     //tty missing
  ...
  soclib::caba::VciVgmn<vci_param> vgmn("vgmn", maptab, 1, 2, 10, 8);
